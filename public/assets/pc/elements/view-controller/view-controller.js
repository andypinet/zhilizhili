...
var ViewController = (function (_polymer$Base) {
    _inherits(ViewController, _polymer$Base);

    function ViewController() {
        _classCallCheck(this, ViewController);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(ViewController).apply(this, arguments));
    }
...
/// <reference path="../../../../../typings/polymer-ts/polymer-ts.d.ts" />
component("view-controller")], ViewController);
