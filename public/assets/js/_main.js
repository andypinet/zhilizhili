(function() {
  ...
  root.MY_CLASS.footerView = (function(superClass) {
    ...
    footerView.prototype.addStage = function() {
      ...
      if (this._isSmt) {
        ...
        this._attention.elm().html("<span id='attention'>Twitterなどのアプリ内ブラウザは<span id='attentionSystem'>推奨環境</span>に含まれません。iOS8以上のsafariブラウザでお楽しみください。</span><br><span id='copyright'>Copyright © A stAtion All Rights Reserved.</span>");
      }
    ...
    footerView.prototype.update = function() {
      if (this._isShowAnimation && (!this._anm.show0.isCompleted() || !this._anm.show1.isCompleted())) {
        ...
        return this._right.setTransform();
      }
    };
    ...
    footerView.prototype.hide = function() {
      this.visible(false);
      return this._isShowAnimation = false;
    };
  ...
  root.MY_CLASS.checkRoad = (function() {
    ...
    checkRoad.prototype._makeRoad = function() {
      ...
      this._container.add(this._mesh);
      console.log("長さ::", this.depthFromBBox(geo.boundingBox));
      return this._at = 0;
    };
  ...
  root.MY_CLASS.conf = (function() {
    function conf() {
      ...
      this.SITE_SHARE_TEXT_TW = "絢香 New Album「レインボーロード」Special Contents <url>";
      this.RESULT_SHARE_TW = this.SITE_SHARE_TW;
      this.RESULT_SHARE_LINE = "http://line.me/R/msg/text/?<text>";
      this.RESULT_SHARE_TEXT_TW = "Record <point>AYAKm #ayaka_rainbowroad 絢香 New Album「レインボーロード」Special Contents <url>";
      this.RESULT_SHARE_TEXT_FB = "Record <point>AYAKm #ayaka_rainbowroad 絢香 New Album「レインボーロード」Special Contents";
      this.RESULT_SHARE_TEXT_LINE = "Record <point>AYAKm 絢香 New Album「レインボーロード」Special Contents <url>";
      ...
      this.MUSIC_NAME = ["にじいろ", "number one", "Have fun!!", "ありがとうの輪", "No end", "ツヨク想う", "beautiful"];
      this.MAX_COMBO = 7;
