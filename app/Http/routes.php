...
Route::get('wex/tsc/{router}', 'WexController@tsc');
Route::get('wex/mtc/{router}', 'WexController@mtc');
Route::get('wex/vtc', 'WexController@vtc');
Route::get('wex/atc', 'WexController@atc');
Route::get('wex/h5', 'WexController@h5');
Route::get('wex/mobile', 'WexController@mobile');
