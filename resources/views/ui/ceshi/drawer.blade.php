<div id="drawerView" class="layout full-parent drawer-view drawer-view--basic">
    <div class="layout__item full-height utility-pos-absolute drawer-view__drawer" style="background-color: #00c4ff">
    ...
    <div class="layout__item full-parent utility-pos-absolute drawer-view__main" touch-action="none">
        ...
        <div id="o" class="full-width utility-pos-absolute" style="left: -999px; top: -999px; z-index: -1; opacity: 0; width: 0; height: 0;"></div>
    </div>
